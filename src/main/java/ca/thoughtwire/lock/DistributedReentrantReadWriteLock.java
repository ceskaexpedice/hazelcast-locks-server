...
public class DistributedReentrantReadWriteLock implements ReadWriteLock {
    ...
    {
        return ((ReadLock)readLock()).getHoldCount();
    }
    ...
    {
        return ((WriteLock)writeLock()).getHoldCount();
    }
     ...
     *
     * {@link Lock#tryLock()},
     * {@link Lock#tryLock(long, TimeUnit)} and
     * {@link Lock#newCondition()} are not supported.
     */
